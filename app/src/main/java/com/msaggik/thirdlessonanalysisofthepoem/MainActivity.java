...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Arrays.sort(poemArray); // Сортировка массива слов

        // Вывод отсортированных слов на экран смартфона
        StringBuilder sortedWords = new StringBuilder("Отсортированные слова:\n");
        for (String word : poemArray) {
            sortedWords.append(word).append("\n");
        }
        output.setText(sortedWords.toString());
    }
